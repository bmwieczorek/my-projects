...
public class Lambda2 {
    ...
    static class Lazy<T> {
        ...
        public boolean isApplicable(T t) {
            return callback.isApplicable(t);
        }
    ...
    public static void main(String[] args) {
        ...
        Callback<Integer> isEvenNumberCallback = new Callback<Integer>() {
            ...
            @Override
            public boolean isApplicable(Integer n) {
