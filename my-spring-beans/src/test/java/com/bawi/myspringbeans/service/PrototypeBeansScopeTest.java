...
@ContextConfiguration(locations = { "/my-service-context.xml", "/my-dao-prototype-bean-scope-context.xml" })
public class PrototypeBeansScopeTest {
    ...
    public void shouldReturnTheSameCachedDependency() {
        ...
        Assert.assertNotSame(managerService.getPersonDao(), workerService.getPersonDao());
    }
}
