...
public class MySpringTest3 {
    ...
    public void shouldXmlClassPathCtxSeeProgramaticallyCreatedBean() throws Exception {
        ...
        ConfigurableApplicationContext context = new ClassPathXmlApplicationContext(new String[] {"my-spring3.xml"}, parentContext);
        MySedaRouteBuilder3 builder = context.getBean(MySedaRouteBuilder3.class);
        
        // then
        Assert.assertEquals(maximumRequestCount, builder.getMaximumRequestCount());
        context.close();
    }
