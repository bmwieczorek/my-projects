...
interface Listener2{ void onSoldItem(Item2 item2); }
...
abstract class AbstractListener2 implements Listener2{
	...
	public void onSoldItem(Item2 item2) {
		System.out.println("[" + this.getClass().getName() + "] Received notification for " + "Item=" + item2.getName() + ",price=" + item2.getPrice());
	}
}
...
public class Shop2 {	
	...
	private void sell(Item2 item2){
		System.out.println("[" + this.getClass().getName() + "] Selling " + item2.getName() + " for " + item2.getPrice() + " ...");
