...
public class Example<T> {
	...
	public static void main(String[] args) {
		// Even though Circle is a Figure (Circle extends Figure), List<Circle> is NOT List<Figure> (List<Circle>
		// doesn't extend List<Figure>). In order to add List<Circle> , you need to change from parameter type from
