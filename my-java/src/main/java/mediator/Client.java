...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        // colleagues are aware of the forum but don't have direct dependency do
        // other colleagues
        ...
        // the send method delegates the call to the mediator which looks up the
        // receiver if registered,
