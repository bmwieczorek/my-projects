...
public class MyRouteBuilder extends RouteBuilder {
    ...
    static final String ORIGINAL_REQUEST_PROPERTY = "originalRequest";
    ...
    public void configure() throws Exception {
        ...
        onException(Throwable.class)
            .handled(true)
            .log(LoggingLevel.WARN, "com.bawi.camel.redelivery.MyRouteBuilder","in on exception throwable")
        ...
        from(MY_DIRECT_START)
            .onException(IllegalArgumentException.class)
                ...
                .handled(true)
                .log(LoggingLevel.INFO, "com.bawi.camel.redelivery.MyRouteBuilder","in main route ON EXCEPTION")
